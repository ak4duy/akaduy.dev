      ...
      <div className="relative mx-auto max-w-2xl px-6 py-16">
        ...
        <header className="mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
            Self-taught developer. Currently working with J*va, Python, Rust, and whatever breaks next.
          </p>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* About Tab */}
            <TabsContent value="about" className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              <section className="group">
                ...
                <div className="space-y-4 text-sm leading-relaxed text-muted-foreground pl-4 border-l-2 border-border hover:border-muted-foreground/50 transition-colors duration-300">
                  <p className="animate-in fade-in duration-500 delay-100">
                    ...
                    <span className="font-medium text-foreground hover:text-primary transition-colors">Lua</span>
                  </p>
                  <p className="animate-in fade-in duration-500 delay-200">
                    ...
                    <span className="font-medium text-foreground">Rust</span>, and whatever breaks next
                  </p>
</div>
              </section>
              ...
              <section className="group">
                ...
                <div className="flex flex-wrap gap-3">
                  {["TypeScript", "JavaScript", "Kotlin", "Go"].map((interest, i) => (
                    <span
                      key={interest}
                      className="rounded-lg bg-muted/50 border border-border px-4 py-2 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground hover:scale-105 transition-all duration-300 cursor-default animate-in fade-in zoom-in-95"
            ...
            {/* Experience Tab */}
            <TabsContent value="experience" className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              <section>
                  ...
                  {[
                    {
                      ...
                      description: "Open-source music player built with Rust and Dioxus. Contributing features and fixing bugs.",
                      tags: ["Rust", "Dioxus"],
                    },
                    {
                      name: "1_10000_jumpscare",
                      href: "https://github.com/ak4duy/1_10000_jumpscare",
                      description: "An add-on that makes your study thrilling. Every second, there is a 1 in 10000 chance that Foxy will randomly jumpscare you.",
              ...
              <section>
                ...
                <div className="group rounded-xl border border-border bg-card/50 p-5 hover:bg-card hover:border-muted-foreground/30 hover:shadow-lg hover:shadow-foreground/5 transition-all duration-300 animate-in fade-in slide-in-from-bottom-2 delay-100">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                    Currently studying and learning things properly (for once).
                  </p>
            ...
            {/* Contact Tab */}
            <TabsContent value="contact" className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="mb-5 text-lg font-semibold flex items-center gap-2">
                <span className="h-1.5 w-1.5 rounded-full bg-foreground" />
                Get in Touch
              </h2>
              <div className="grid gap-3">
                {[
                  { href: "https://github.com/ak4duy", icon: Github, label: "GitHub", value: "@ak4duy", external: true },
                  { href: "https://discord.com/users/799965541283528714", icon: MessageCircle, label: "Discord", value: "ak4duy", external: true },
                  { href: "mailto:akaduy@protonmail.me", icon: Mail, label: "Email", value: "akaduy@protonmail.me", external: false },
                  { href: "https://github.com/ak4duy.gpg", icon: Key, label: "PGP Key", value: "For encrypted communication", external: true },
                ].map((contact, i) => (
                  <Link
                    key={contact.label}
                    href={contact.href}
